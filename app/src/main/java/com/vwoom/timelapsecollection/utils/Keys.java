...
public final class Keys {
    ...
    /* Authorities */
    public static final String FILEPROVIDER_AUTHORITY = "com.vwoom.timelapsecollection.fileprovider";
    public static final String PREFERENCES_KEY = "com.vwoom.timelapsecollection.preferences";
    public static final String CREATE_NOTIFICATION_AUTHORITY = "com.vwoom.timelapsecollection.CREATE_NOTIFICATION";
}