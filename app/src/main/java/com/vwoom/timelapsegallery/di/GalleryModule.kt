...
abstract class GalleryModule {
    ...
    class InjectViewModel {
        ...
        fun provideGalleryViewModel(projectRepository: ProjectRepository, tagRepository: TagRepository, weatherRepository: WeatherRepository):
                ViewModel = GalleryViewModel(projectRepository, tagRepository, weatherRepository)
    }
}